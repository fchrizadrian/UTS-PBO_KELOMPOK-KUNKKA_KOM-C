...
public class Modify extends javax.swing.JFrame {
   ...
   ResultSet result;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Menu Edit User", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(204, 153, 255))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     try{
         ...
         String sql="Update user set username='"+username.getText()+"'," + "password='"+password.getText()+"'," + "nama='"+nama.getText()+"'where username='"+username.getText()+"'";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
           ...
           konek=k1.koneksi();
           String str="select * from user where id_user=?" ;
           ...
           if (result.next()){
               ...
               role_id.setText(result.getString("role_id"));
           }
           else{
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
     ...
     try{
           Koneksi k1=new Koneksi();
           konek=k1.koneksi();
           String str="Delete from user where id_user='"+id_user.getText()+"'" ;
           PreparedStatement stmt=konek.prepareStatement(str);
           stmt.executeUpdate();
